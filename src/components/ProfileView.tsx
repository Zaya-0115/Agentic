    ...
    <div className="flex-1 flex flex-col bg-[#f5f5f7] overflow-y-auto">
      <div className="max-w-2xl mx-auto w-full px-6 py-8 space-y-6">
        ...
        {activeSection === "settings" && (
          <div className="space-y-2">
            {["Мэдэгдэл", "Хэл солих", "Нууцлалын тохиргоо"].map((s) => (
              <div key={s} className="bg-white rounded-2xl border border-gray-100 px-4 py-3.5 flex items-center justify-between">
        ...
        {/* Logout */}
        <button className="w-full py-3 border border-red-200 text-red-500 rounded-2xl text-sm font-medium hover:bg-red-50 transition-colors">
          Гарах
        </button>
      </div>
    </div>
